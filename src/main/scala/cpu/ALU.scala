...
class ComplexALU extends Component {
  ...
  switch(io.input.op) {
    ...
    is(div) {
      io.c := divide.remainder.twoComplement(io.input.a(31))(0, 32 bits).asUInt
      io.d := divide.quotient.twoComplement(io.input.a(31) ^ io.input.b(31))(0, 32 bits).asUInt
    }
    is(divu) {
